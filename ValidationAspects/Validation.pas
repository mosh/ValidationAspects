...
begin
  ...
  var genericRuleViolation:=Services.CreateGenericInstance(
    ...
    [Services.FindType('Validation.RuleViolation')]
    );
...
begin
  ...
  aType.AddInterface(Services.GetType('System.ComponentModel.IDataErrorInfo'));
...
begin
  ...
  //var itemValidationValue := new LocalVariable('itemValidationValue',Services.FindType('System.String'));
  //var itemValidationValueAssignment := new AssignmentStatement(new BeginLocalValue(itemValidationValue), new NilValue);  
//
  //var methodBegin:BeginStatement := new BeginStatement([itemValidationValue],
     //[
       //itemValidationValueAssignment
     //]);
//
//
     //methodBegin.Add(new AssignmentStatement(new BeginLocalValue(itemValidationValue),
      //new StaticValue(Services.GetType('System.String'),'Empty'))
      //);


  var itemValidationValueField := itemGetterDefinition.Owner.AddField('itemValidationValue', Services.FindType('System.String'), false);
  ...
  var assignResult := new AssignmentStatement(new ResultValue, new FieldValue(new SelfValue, itemValidationValueField));

  //methodBegin.Add(assignResult);
...
begin
  ...
  var getInstanceProc:= new ProcValue(new TypeValue(Services.FindType('System.Linq.Enumerable')), 
        'Count', [Services.FindType('Validation.RuleViolation') as IType],  [getRuleViolationCall]);
